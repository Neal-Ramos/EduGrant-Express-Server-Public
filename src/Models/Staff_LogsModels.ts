import { PrismaClient, Staff_Logs } from "@prisma/client";
...
export const prismaGetStaffLogs = async(isHead: boolean, page?: number, dataPerPage?: number, sortBy?: string, order?: string, ownderId?: number, 
    filters?: {id:string, value:[string]}[]): Promise<{logs: Staff_Logs[], totalCount: number}>=> {
