...
export type approveApplicationZodType = z.infer<typeof approveApplicationZodSchema>;
...
export type declineApplicationZodType = z.infer<typeof declineApplicationZodSchema>;
...
export type getFileUrlZodSchemaZodType = z.infer<typeof getFileUrlZodSchemaZodSchema>;
...
export type getApplicationByIdZodType = z.infer<typeof getApplicationByIdZodSchema>;
...
export type searchApplicationZodType = z.infer<typeof searchApplicationZodSchema>;
...
export type adminAddScholarshipsZodType = z.infer<typeof adminAddScholarshipsZodSchema>;
...
export type updateScholarshipZodType = z.infer<typeof updateScholarshipZodSchema>;
...
export type deleteScholarshipZodType = z.infer<typeof deleteScholarshipZodSchema>;
...
export type createAnnouncementZodType = z.infer<typeof createAnnouncementZodSchema>;
...
export const getFiltersCSVZodSchema = z.object({
  query: z.object({
    scholarship: toJSON()
      .refine((e) => Array.isArray(e) && e.every((item) => typeof item === 'string'), {
        message: 'Must be an Array of Strings',
      })
      .optional(),
    applicationStatus: toJSON()
      .refine((e) => Array.isArray(e) && e.every((item) => typeof item === 'string'), {
        message: 'Must be an Array of Strings',
      })
      .optional(),
    studentInstitute: toJSON()
      .refine((e) => Array.isArray(e) && e.every((item) => typeof item === 'string'), {
        message: 'Must be an Array of Strings',
      })
      .optional(),
...
export const downloadApplicationCSVZodSchema = z.object({
  query: z.object({
    filters: toJSON()
      .refine((e) => Array.isArray(e) && e.every((item) => typeof item == 'object'))
      .optional(),
    dataSelections: toJSON().refine(
      (e) => Array.isArray(e) && e.every((item) => typeof item == 'string'),
    ),
    AtoZ: toJSON()
      .refine((e) => typeof e == 'object' && e?.start && e?.end, { message: 'Error Value!' })
      .optional(),
    order: z
      .string()
      .refine((e) => e === 'asc' || e === 'desc', { message: 'Error Value!' })
      .optional(),
    gender: z
      .string()
      .refine((e) => e === 'Male' || e === 'Female', { message: 'Error Value!' })
      .optional(),
  }),
});
