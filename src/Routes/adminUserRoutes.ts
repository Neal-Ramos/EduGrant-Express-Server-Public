...
import {
  ...
  editHead,
  editStaff,
  editStaffCredSendAuthCode,
  editStaffInfoAccount,
  updateTour,
} from '../Controller/adminUserControllers';
...
AdminUserRoutes.post(
  '/editStaffAccount',
  upload.any(),
  validate(editStaffInfoZodSchema),
  editStaffInfoAccount,
);
AdminUserRoutes.post(
  '/editStaffCredSendAuthCode',
  validate(editStaffCredSendAuthCodeZodSchema),
  editStaffCredSendAuthCode,
);
