...
import {
  adminCodeAuthentication,
  adminLogIn,
  forgetPass,
  sendAuthCodeForgetPass,
} from '../Controller/adminAuthControllers';
import { validate } from '../Validator/Validator';
import {
  adminCodeAuthenticationZodSchema,
  adminLoginZodSchema,
  adminTokenAuthenticationZodSchema,
  createAccountZodSchema,
  forgetPassZodSchema,
  sendAuthCodeForgetPassZodSchema,
  superAdminTokenAuthenticationZodSchema,
...
AdminAuthRoutes.post(
  '/adminCodeAuthentication',
  validate(adminCodeAuthenticationZodSchema),
  adminCodeAuthentication,
);
AdminAuthRoutes.post(
  '/sendAuthCodeForgetPass',
  validate(sendAuthCodeForgetPassZodSchema),
  sendAuthCodeForgetPass,
);
